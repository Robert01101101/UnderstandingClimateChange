    ...
    function(data1) {
      ...
      function(data2) {
        ...
        var y1 = d3.scaleLinear()
          .domain([d3.min(data1, function(d) { return d.mtDiff; }), d3.max(data1, function(d) { return d.mtDiff; })])
          .range([ height, 0 ]);
        svg.append("g")
          .attr("class", "axisBlue")
          .call(d3.axisLeft(y1));
        ...
        var yLabels1 = ["Canadian", "Temperature", "Deviation", "(average),", "in °C"];
        ...
        svg.append("path")
          ...
          .attr("d", d3.line()
            ...
            .y(function(d) { return y1(d.mtDiff) })
            )
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////// CANADIAN WEATHER - Cursor
        ...
        function mousemoveA(x0) {
          ...
          focus1
            ...
            .attr("cy", y1(parseFloat(selectedData1.mtDiff)))
          focusText1
            .html("year: " + selectedData1.year.getFullYear() + "&nbsp; |  &nbsp;" + "tDiff: " + d3.format(".3")(parseFloat(selectedData1.mtDiff)) + "°C")
            .attr("x", x1(selectedData1.year)-w2/2)
            .attr("y", y1(parseFloat(selectedData1.mtDiff))+cursorPos.btmY+cursorPos.h/2)
          focus1BG
            .attr('x', x1(selectedData1.year)-w2/2-10)
            .attr('y', y1(parseFloat(selectedData1.mtDiff))+cursorPos.btmY)
          mousemoveB(x0);
        }
