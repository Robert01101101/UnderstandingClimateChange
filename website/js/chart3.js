//////////////////////////////////////////////////////////////////// CO2 EMISSIONS /////////////////////////////////////////////////////////////////
var url = "data/annual-co-emissions-world.csv";
...
(function(){
  ...
  d3.csv(url,
    ...
    function(data) {
      ...
      var yLabels = ["Annual", "total CO2",  "emissions,", "in tonnes", "(World)"];
  ...
  function mousemove() {
    ...
    focusText
      .html("year:" + selectedData.year.getFullYear() + "    |    " + "tonnes:" + d3.format(".3s")(parseInt(selectedData.co2)))
      .attr("x", x(selectedData.year))
      .attr("y", y(parseInt(selectedData.co2))+30)
