    ...
    function(data1) {
      ...
      function(data2) {
        ...
        var y1 = d3.scaleLinear()
          .domain([d3.min(data1, function(d) { return d.mtDiffAbs; }), d3.max(data1, function(d) { return d.mtDiffAbs; })])
          .range([ height, 0 ]);
        svg.append("g")
          .attr("class", "axisBlue")
          .call(d3.axisLeft(y1));
        ...
        var yLabels1 = ["Canadian", "Temperature", "Deviation" , "(average,", "absolute), ", "in °C"];
        ...
        svg.append("path")
          ...
          .attr("d", d3.line()
            ...
            .y(function(d) { return y1(d.mtDiffAbs) })
            )
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////// CANADIAN WEATHER - Cursor
        ...
        function mousemoveA(x0) {
          ...
          focus1
            ...
            .attr("cy", y1(parseFloat(selectedData1.mtDiffAbs)))
          focusText1
            .html("year: " + selectedData1.year.getFullYear() + "&nbsp; |  &nbsp;" + "tDiffAbs: " + d3.format(".3")(parseFloat(selectedData1.mtDiffAbs)) + "°C")
            .attr("x", x1(selectedData1.year)-w2/2)
            .attr("y", y1(parseFloat(selectedData1.mtDiffAbs))+cursorPos.btmY+cursorPos.h/2)
          focus1BG
            .attr('x', x1(selectedData1.year)-w2/2-10)
            .attr('y', y1(parseFloat(selectedData1.mtDiffAbs))+cursorPos.btmY)
          mousemoveB(x0);
        }
