...
function drawSumChartT(){
  ...
  d3.csv(url,
    ...
    function(data) {
      ...
      var y = d3.scaleLinear()
        .domain([d3.min(data, function(d) { return d.mpDiffAbs; }), d3.max(data, function(d) { return d.mpDiffAbs; })])
        .range([ height, 0 ]);
      svg.append("g")
        .attr("class", "axisWhite")
        .call(d3.axisLeft(y));
      ...
      svg.append("path")
        ...
        .attr("d", d3.line()
          ...
          .y(function(d) { return y(d.mpDiffAbs) })
          )
  ...
  function mousemove() {
    ...
    focus
      ...
      .attr("cy", y(parseFloat(selectedData.mpDiffAbs)))
    focusText
      .html("year:" + selectedData.year.getFullYear() + "    |    " + "tDiff:" +d3.format(".3f")(parseFloat(selectedData.mpDiffAbs)) + "°C")
      .attr("x", x(selectedData.year))
      .attr("y", y(parseFloat(selectedData.mpDiffAbs))+30)
    }
  function mouseout() {
